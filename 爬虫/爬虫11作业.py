...
account =  'jw78@netvigator.com'
password = input('请输入密码：')
receiver = 'jw78@yahoo.com'
index = 0
# index的目的是让程序只运行两次就结束

def get_weather():
    url = 'http://www.weather.com.cn/weather1d/101211001.shtm'
    res = requests.get('url')
    page = BeautifulSoup(res.text, 'html.parser')
    data = page.find('div', class_='pl2')
    list_all = []
...
def send_email(movie_list):
    ...
    mailhost = 'Serversmtp-relay.sendinblue.com'
